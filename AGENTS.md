...
**DClaw Wiki** is a vertical SaaS application built on the DClaw Stack.

- **Backend Port:** `8025` (FastAPI)
- **Frontend Port:** `3025` (Next.js)
- **Database:** `dclaw_wiki` (PostgreSQL)
...
- **Frontend:** `node:20-alpine`, port `3025`
